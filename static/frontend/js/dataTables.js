...
!function (n) {
    "use strict";
    var a;
    "function" == typeof define && define.amd ? define(["static/frontend/js/jquery"], function (t) {
        return n(t, window, document)
    }) : "object" == typeof exports ? (a = require("static/frontend/js/jquery"), "undefined" == typeof window ? module.exports = function (t, e) {
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: "مرتب کردن ستون به صورت صعودی :",
                sSortDescending: "مرتب کردن ستون به صورت نزولی :"
            },
            oPaginate: {sFirst: "اولی",sPrevious: "قبلی" ,  sNext: "بعدی", sLast: "آخری"},
            sEmptyTable: "داده ای در جدول وجود ندارد",
            sInfo: "نمایش کامل _START_ تا _END_ از _TOTAL_",
            sInfoEmpty: "",
            sInfoFiltered: "(از _MAX_ تا فیلتر شده)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "تعداد _MENU_ نشان بده",
            sLoadingRecords: "بررسی ...",
            sProcessing: "",
            sSearch: "",
            sSearchPlaceholder: "جست و جو",
            sUrl: "",
            sZeroRecords: "هیچ داده منطبقی یافت نشد"
        },
